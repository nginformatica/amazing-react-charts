  ...
  <AudiometryChart
    ...
    data={[[
      ...
      },
      {
        result: 60,
        boneResult: 50,
        boneSymbol: 'path://M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5'
...
export const audiometryChartWithDashedLine = () => (
  <AudiometryChart
    ...
    data={[[
      {
        result: 60,
        symbol: 'path://M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5'
                    + ' 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z'
      },
      {
        result: 50,
...
export const audiometryChartWithConcurrentLines = () => (
  <AudiometryChart
    ...
    legends={[
      {
        name: 'mark',
        icon: 'path://M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5' +
                    ' 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z'
      },
      {
        name: 'red',
    ...
    data={[[
      {
        ...
        symbol: 'path://M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5'
                    + ' 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z',
        boneResult: 10,
        boneSymbol: 'path://M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12'
